 ...
 * @param rule {Rule}
 */
QueryBuilder.prototype.CreatoruleFilters = function(rule) {
    var filters = this.change('getRuleFilters', this.filters, rule);
    var $filterSelect = $(this.getRuleFilterSelect(rule, filters));

    rule.$el.find(Selectors.filter_container).html($filterSelect);

    this.trigger('afterCreatoruleFilters', rule);
};
 ...
 * @param rule {Rule}
 */
QueryBuilder.prototype.CreatoruleOperators = function(rule) {
    ...
    this.trigger('afterCreatoruleOperators', rule, operators);
};
 ...
 * @param rule {Rule}
 */
QueryBuilder.prototype.CreatoruleInput = function(rule) {
    ...
    this.trigger('afterCreatoruleInput', rule);
...
QueryBuilder.prototype.updateRuleFilter = function(rule) {
    this.CreatoruleOperators(rule);
    this.CreatoruleInput(rule);
...
QueryBuilder.define('bt-selectpicker', function(options) {
    ...
    // init selectpicker
    this.on('afterCreatoruleFilters', function(e, rule) {
        rule.$el.find(Selectors.rule_filter).removeClass('form-control').selectpicker(options);
    });

    this.on('afterCreatoruleOperators', function(e, rule) {
...
QueryBuilder.define('unique-filter', function() {
    ...
    this.on('afterCreatoruleFilters', this.applyDisabledFilters);
...
QueryBuilder.regional['en'] = {
  ...
  "add_rule": "Add Main Condition",
  "add_group": "Add Sub Condition",
  "delete_rule": "Delete",
  "delete_group": "Delete",
  "conditions": {
    "AND": "AND",
